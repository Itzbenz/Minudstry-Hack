...
public class SWorkshop implements SteamUGCCallback{
    ...
    private final ObjectMap<Class<? extends Publishable>, Array<Fi>> workshopFiles = new ObjectMap<>();
    private final ObjectMap<SteamUGCQuery, Cons2<Array<SteamUGCDetails>, SteamResult>> detailHandlers = new ObjectMap<>();
    private final Array<Cons<SteamPublishedFileID>> itemHandlers = new Array<>();
    private final ObjectMap<SteamPublishedFileID, Runnable> updatedHandlers = new ObjectMap<>();
