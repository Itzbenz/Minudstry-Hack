...
public class EventType{
    ...
    public static class BotLoadEvent{
    ...
    public static class receivedPayload {
        public final Socket socket;
        public final String payload;

        public receivedPayload(Socket socket, String payload) {
            this.socket = socket;
            this.payload = payload;
        }
        public void respond(String data){
            String httpResponse = "HTTP/1.1 200 OK\r\n\r\n" + data;
            try { this.socket.getOutputStream().write(httpResponse.getBytes(Charset.forName("UTF-8"))); } catch (IOException ignored) {}
        }
