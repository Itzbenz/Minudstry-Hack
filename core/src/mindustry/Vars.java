...
import Photon.ToolKit.GriefWarnings;
...
public class Vars implements Loadable{
    ...
    public static final String appName = "Mindustry-Oxygen";
    ...
    public static final String crashReportURL = "http://192.1.1.1/report";
            ...
            if(!headless && (ui == null || ui.scriptfrag == null)){
                ...
                try {
                    if(result.length() < 200) {
                        ...
                        ui.javaEditor.messages.add(result);
                    }
                    if(level.ordinal() == 3)
